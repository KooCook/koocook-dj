...
urlpatterns = [
    ...
    path('ingredients', views.RecipeIngredientsView.as_view()),  # TODO: Register this route.
    path('equipment', views.RecipeEquipmentView.as_view()),  # TODO: Register this route.
]
