# Generated by Django 2.2.6 on 2019-11-09 07:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=63)),
                ('nutrient', django.contrib.postgres.fields.jsonb.JSONField()),
            ],
        ),
        migrations.CreateModel(
            name='Post',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=63)),
                ('label', models.IntegerField(blank=True, null=True, validators=[django.core.validators.MinValueValidator(1), django.core.validators.MaxValueValidator(4)])),
            ],
        ),
        migrations.CreateModel(
            name='Recipe',
            fields=[
                ...
                ('recipe_yield', koocook_core.support.quantity.QuantityField(max_length=50, nau=True)),
                ('aggregate_rating', models.OneToOneField(on_delete=django.db.models.deletion.PROTECT, to='koocook_core.AggregateRating')),
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='koocook_core.Author')),
                ('tag_set', models.ManyToManyField(blank=True, to='koocook_core.Tag')),
            ],
        ),
        migrations.CreateModel(
            name='Rating',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('substitute_set', models.ManyToManyField(related_name='_ingredient_substitute_set_+', to='koocook_core.Ingredient')),
            ],
        ),
        migrations.AddField(
            model_name='comment',
